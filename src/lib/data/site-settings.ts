...
export const siteSettings: SiteSettings = {
  ...
  seo: {
    ...
    description: "Your trusted B2B & B2C provider of Dotmatrix, Laser, and Ink Tank printers, essential spare parts, and dedicated repair services with over 30 years of industry expertise.",
    keywords: ["Dotmatrix printers", "Laser printers", "Ink tank printers", "Printer parts", "Computer peripherals", "Printer consumables", "Rex International", "Printer repair Mumbai"]
  }
};
