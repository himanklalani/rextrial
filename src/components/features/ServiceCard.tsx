      ...
      <div className="flex flex-col flex-1 p-5 sm:p-6">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-brand-gray/15 mt-auto">
          ...
          <a
            ...
            className="flex items-center gap-1.5 bg-brand-dark text-brand-white-pure text-xs font-bold px-3 py-2 rounded-lg hover:bg-brand-green hover:text-brand-dark transition-colors duration-200"
          >
